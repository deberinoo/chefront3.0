...
const CLIENT_SECRET = 'OFlTJIN5MWEFMrFZY9KD7CUj'
const REDIRECT_URI = 'https://developers.google.com/oauthplayground'
const REFRESH_TOKEN = '1//04ANTgFwaSjqqCgYIARAAGAQSNwF-L9Ir1tR1z_Vnhw-SyfUfwbdbusbGai03t6G6C25O4QWHCsXBnxX6dGnMa7QbQ5-ccpL1Td8'
...
export async function sendMailPasswordChange(email) {
	try {
		...
		const mailOptions = {
			...
			text: 'Hello from the CEO',
			html: `<p>You requested for a password reset, kindly use this <a href='http://localhost:3000/auth/resetPassword/${email}'>Link</a> to reset your password</p>`,
		};
