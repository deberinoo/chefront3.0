...
export async function sendMailUpdateBusiness(email,name,contact,password ) {
	try {
		const accessToken = await oAuth2Client.getAccessToken();
...
export async function sendMailCreateOutlet(email,business_name,location,address,Postalcode) {
	try {
		const accessToken = await oAuth2Client.getAccessToken();
